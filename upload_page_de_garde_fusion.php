...
try {
    ...
    if (!in_array($ext, ['xls', 'xlsx'])) {
        throw new Exception('Format de fichier invalide. Accepté: XLS, XLSX');
    }
    ...
    echo json_encode(['success' => true, 'message' => 'Page de garde enregistrée']);
